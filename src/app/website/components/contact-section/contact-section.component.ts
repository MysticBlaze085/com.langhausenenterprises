...
export class ContactSectionComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.submissionForm = collection(this.firestore, 'contactSubmissions');
    ...
    Calendly.initInlineWidget({
      url: 'https://calendly.com/langhausenenterprises/phone-jukebox-repair-service?hide_event_type_details=1&background_color=4d5055&text_color=ffffff&primary_color=ffc107',
